...
static inline NSDictionary * NSAttributedStringAttributesFromLabel(CCLabel *label) {
...
@property (readwrite, nonatomic, strong) CCLabelLink *activeLink;
                                  ...
                                  attributes:(NSDictionary *)attributes
{
    ...
    for (NSTextCheckingResult *result in results) {
        ...
        CCLabelLink *link = [[CCLabelLink alloc] initWithAttributes:attributes
...
- (CCLabelLink *)linkAtPoint:(CGPoint)point {
    ...
    CCLabelLink *result = [self linkAtCharacterIndex:[self characterIndexAtPoint:point]];
...
- (CCLabelLink *)linkAtRadius:(const CGFloat)radius aroundPoint:(CGPoint)point {
...
- (CCLabelLink *)linkAtCharacterIndex:(CFIndex)idx {
...
- (void)setActiveLink:(CCLabelLink *)activeLink {
...
- (NSArray *)accessibilityElements {
    if (!_accessibilityElements) {
        @synchronized(self) {
            ...
            for (CCLabelLink *link in self.linkModels) {
...
- (void)longPressGestureDidFire:(UILongPressGestureRecognizer *)sender {
    switch (sender.state) {
        case UIGestureRecognizerStateBegan: {
            ...
            CCLabelLink *link = [self linkAtPoint:touchPoint];
...
#pragma mark - CCLabelLink

@implementation CCLabelLink
